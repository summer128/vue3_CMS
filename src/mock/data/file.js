...
export const fileType = [
  { name: "全部", value: 0, menuIcon: "menu-file", icon: "Folder" },
  { name: "图片", value: 1, menuIcon: "file-image", icon: "PictureFilled" },
  { name: "文档", value: 2, menuIcon: "file-txt", icon: "Document" },
  { name: "视频", value: 3, menuIcon: "file-video", icon: "VideoCameraFilled" },
  { name: "音频", value: 4, menuIcon: "file-music", icon: "Microphone" },
  { name: "其他", value: 5, menuIcon: "file-other", icon: "More" },
];
